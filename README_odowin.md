...
- 🛠️ **Le réparateur** : corrige les bugs, résout les conflits, gère les branches _hotfix_.
...
- Les trois membres de l'équipe vérifient qu'ils peuvent pousser des modifications en créant un fichier README\_<pseudo_github>.md, en écrivant leur prénom à l'intérieur, et en le poussant sur le répo distant après l'avoir add puis commit.
